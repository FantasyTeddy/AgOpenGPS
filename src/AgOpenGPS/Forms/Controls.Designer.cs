...
namespace AgOpenGPS
{
    public partial class FormGPS
    {
        ...
        {
            foreach (ToolStripMenuItem menuItem in menustripLanguage.DropDownItems.OfType<ToolStripMenuItem>())
            {
        ...
        {
            if (sim.stepDistance is < 0.2 and > -0.51) sim.stepDistance -= 0.02;
